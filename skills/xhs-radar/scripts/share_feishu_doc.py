...
def main():
    if len(sys.argv) < 2:
        raise SystemExit("Usage: python share_feishu_doc.py <document_id_or_url> [email|openid|unionid|userid] [member_id] [view|edit|full_access] [docx|doc|sheet|file|bitable]")
